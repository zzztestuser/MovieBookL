...
<body>
	...
	<div class="eventsList" style="clear: both; display: none">
		<h2>Invites</h2>
		<div class="eventItem" style="border: 1px solid lightgray; margin: 10px; float: left; padding: 5px; height: 140px; width: 400px">
			<div class="eventItemDetails" >
				...
				<span class="eventInviteLabel" style="font-weight: bold; display: inline-block; min-width: 100px; margin-right: 10px">Invite status</span><span class="eventInviteStatus"></span><br />
			</div>
